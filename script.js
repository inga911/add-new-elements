...
function setTextColor(colorBox, color) {
    const brightnessThreshold = 100;
    const textColor = getColorBrightness(color.rgb) < brightnessThreshold ? 'white' : 'black';
...
currentColor.style.border = '1px solid grey'
currentColor.style.height = '100px'
currentColor.style.width = '100%'
currentColor.style.margin = '30px'
currentColor.style.borderRadius = '10px'
currentColor.style.display = 'flex'
currentColor.style.justifyContent = 'center'
currentColor.style.alignItems = 'center'
main.appendChild(currentColor)

//color name
//current color
const currentcolorName = document.createElement('div')
currentcolorName.innerHTML = ''
currentcolorName.style.fontSize = '25px'
currentcolorName.style.letterSpacing = '2px'
currentcolorName.style.fontFamily = 'monospace'
currentColor.appendChild(currentcolorName)


for (let color of colors) {
    const colorBox = document.createElement('div')
    colorBox.style.border = '1px solid grey'
    colorBox.style.height = '130px'
